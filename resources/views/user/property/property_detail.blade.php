                ...
                <div class="col-lg-12">
                    <div class="section__breadcrumb-v1">
                        <ol class="breadcrumb mb-0 bg-light">
                            <li class="breadcrumb-item"><a href="{{ route('property.index') }}"><i class="fa fa-home"></i> </a>
                            </li>
                        ...
                        <div class="profile__agent mb-30">
                            <div class="profile__agent__group">
                                ...
                                <div class="profile__agent__footer">
                                    <div class="form-group mb-0">
                                        <a href="https://wa.me/{{ $property->user->contact }}"
                                            class="btn btn-primary text-capitalize btn-block">Contact with Agent <i
